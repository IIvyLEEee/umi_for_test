...
from diffusion_policy.model.vision.multi_attn_pooling import MultiheadAttentionPooling
...
class TransformerObsEncoder(ModuleAttrMixin):
    def __init__(
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if type == "rgb":
                ...
                token_pooling = MultiheadAttentionPooling(
    ...
    def forward(self, obs_dict):
        ...
        for key in self.rgb_keys:
            ...
            # print("feature:", img.size())
            raw_feature = self.key_model_map[key](img)
            feature = self.aggregate_feature(raw_feature)
            # print("feature:", feature.size())
            feature = self.token_pooling(feature)
            # print("feature:", feature.size())

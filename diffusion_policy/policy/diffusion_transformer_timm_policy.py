...
from diffusion_policy.model.our_module.transformer_for_action_diffusion import TransformerForActionDiffusion
from diffusion_policy.common.pytorch_util import dict_apply

from diffusion_policy.model.vision.transformer_obs_encoder import TransformerObsEncoder

from diffusion_policy.noise.generator import Generator
...
class DiffusionTransformerTimmPolicy(BaseImagePolicy):
    ...
    def conditional_sample(self, 
        ...
        trajectory = torch.randn(
            ...
            generator=generator)
        # r = Generator(42)
        # trajectory = r.gaussian(condition_data.shape)
        # trajectory = torch.from_numpy(trajectory).to(
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # process input
        # print("obs_encoder.input:", nobs.max())
        obs_tokens = self.obs_encoder(nobs)
        # print("obs_encoder.output:", obs_tokens.max())
        # exit()
        # (B, N, n_emb)
